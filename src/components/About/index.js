      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Getacher Ashebir,</span> a Web
            Enthusiast
          </h3>
          <p
          ...
          >
            ...
            currently Working in Ethiopian Airlines As Full Stack Developer. I am {getDate()}{" "}
          ...
          >
            ...
            I worked on .NET reactJs, NextJs, TypeScript, Java and many more. I am
